...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-package-handling-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-package-handling-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-package-handling
# for installing globally
pixi global install conda-package-handling
```
...
It is possible to list all of the versions of `conda-package-handling` available on your platform:
...
```
pixi search conda-package-handling --channel conda-forge
```
