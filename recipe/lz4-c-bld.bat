...
set VSPROJ_DIR=%SRC_DIR%\lz4_c\visual\VS2017
...
:: Install.
COPY %SRC_DIR%\lz4_c\lib\lz4.h %LIBRARY_INC%
if errorlevel 1 exit 1
COPY %SRC_DIR%\lz4_c\lib\lz4hc.h %LIBRARY_INC%
if errorlevel 1 exit 1
COPY %SRC_DIR%\lz4_c\lib\lz4frame.h %LIBRARY_INC%
if errorlevel 1 exit 1
